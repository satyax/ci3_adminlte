...
class Mst_categories_model extends MY_Model {
  public $_table = 'mst_categories';
  public $primary_key = 'id_categories';
  public $protected_attributes = array( 'id_categories' );
