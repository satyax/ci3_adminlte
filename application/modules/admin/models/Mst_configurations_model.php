...
class Mst_configurations_model extends MY_Model {
  public $_table = 'mst_configurations';
  public $primary_key = 'id_configurations';
  public $protected_attributes = array( 'id_configurations' );
