...
class Trs_notes_email_to_model extends MY_Model {
  public $_table = 'trs_notes_email_to';
  public $primary_key = 'id_notes_email_to';
  public $protected_attributes = array( 'id_notes_email_to' );
