...
class Mst_auth_admin_model extends MY_Model {
  public $_table = 'mst_auth_admin';
  public $primary_key = 'id_auth_admin';
  public $protected_attributes = array( 'id_auth_admin' );
