<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <button type="button" class="btn btn-primary" onclick="addFormGodPad()">
        New godpad entry
      </button>
    </div>
  </div>
